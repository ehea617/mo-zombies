...
public class EntityZombieCyborg extends EntityMob
{
    ...
    protected void dropRareDrop(int par1)
    {
        switch (this.rand.nextInt(7))
        {
            case 0:
                ...
                break;
            case 1:
                this.dropItem(Items.comparator, 1);
                break;
            case 2:
                this.dropItem(Item.getItemFromBlock(Blocks.redstone_torch), 1);
                break;
            case 3:
                this.dropItem(Item.getItemFromBlock(Blocks.redstone_block), 1);
                break;
            case 4:
                this.dropItem(Item.getItemFromBlock(Blocks.dispenser), 1);
                break;
            case 5:
                this.dropItem(Item.getItemFromBlock(Blocks.dropper), 1);
                break;
            case 6:
                this.dropItem(Item.getItemFromBlock(Blocks.lever), 1);
        }
    }
}
